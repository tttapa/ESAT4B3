...
Analog knobsTop[] = {
    {A4, 0x04, 1}, // Create a new instance of class 'Analog' on pin A4, controller number 0x10 (General Purpose Controller 1), on MIDI channel 1.
    {A5, 0x05, 1},
    {A6, 0x06, 1},
    {A7, 0x07, 1},
};
...
void setup()
{
    ...
    bank.add(knobsTop, Bank::CHANGE_CHANNEL);
    bank.add(switches, Bank::CHANGE_CHANNEL);
}
