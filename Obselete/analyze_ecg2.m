function [ RESULT_peaks, RESULT_locations ] = analyze_ecg2( INPUT_data, INPUT_fs, INPUT_maxBPM )
...
while counter <= totalCount
    ...
    [curPeaks, curLocations] = find_peaks(detrendedData, cutOffValue, min([minSamplesPerHeartbeat, length(detrendedData) - 2]));
